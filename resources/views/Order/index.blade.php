                        ...
                        <div class="table-responsive">
                            <table class='table mb-0' id="table1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                <a href="{{ route('Order-Detail',$o->id) }}" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Detail Pesanan</a>
